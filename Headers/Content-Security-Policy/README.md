...
The CSP header, is the client web-page resource security, while "CORS", covered in the "Access-Control" headers section of this repository, are server connection resource security headers.
